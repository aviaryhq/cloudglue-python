...
class FilesApi:
    ...
    def list_file_segments(
        ...
        min_duration: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Filter segments with duration greater than or equal to this value (in seconds)")] = None,
        max_duration: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Filter segments with duration less than or equal to this value (in seconds). Must be greater than or equal to min_duration when both are provided.")] = None,
        ...
        :param min_duration: Filter segments with duration greater than or equal to this value (in seconds)
        :type min_duration: float
        :param max_duration: Filter segments with duration less than or equal to this value (in seconds). Must be greater than or equal to min_duration when both are provided.
