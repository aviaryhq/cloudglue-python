...
class SearchFilterFileInner(BaseModel):
    """
    ...
    def path_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bytes', 'filename', 'uri', 'created_at', 'id']):
            raise ValueError("must be one of enum values ('bytes', 'filename', 'uri', 'created_at', 'id')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchFilterFileInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchFilterFileInner from a dict"""
        if obj is None:
            return None
