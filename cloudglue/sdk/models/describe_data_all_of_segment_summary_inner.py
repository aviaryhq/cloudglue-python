...
class DescribeDataAllOfSegmentSummaryInner(BaseModel):
    """
    DescribeDataAllOfSegmentSummaryInner
    """ # noqa: E501
    ...
    thumbnail_url: Optional[StrictStr] = Field(default=None, description="URL of the segment thumbnail, when available.")
    __properties: ClassVar[List[str]] = ["title", "summary", "start_time", "end_time", "thumbnail_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DescribeDataAllOfSegmentSummaryInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DescribeDataAllOfSegmentSummaryInner from a dict"""
        if obj is None:
            return None
