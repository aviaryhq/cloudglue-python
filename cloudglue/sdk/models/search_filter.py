...
class SearchFilter(BaseModel):
    ...
    SearchFilter
    """ # noqa: E501
    metadata: Optional[List[SearchFilterCriteria]] = Field(default=None, description="Filter by file metadata using JSON path expressions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": [SearchFilterCriteria.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
