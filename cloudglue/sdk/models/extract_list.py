...
class ExtractList(BaseModel):
    ...
    data: List[Extract] = Field(description="Array of extract job objects")
    total: StrictInt = Field(description="Total number of extract jobs matching the query")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtractList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtractList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [Extract.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
