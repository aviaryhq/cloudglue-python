...
class NewExtract(BaseModel):
    ...
    enable_video_level_entities: Optional[StrictBool] = Field(default=None, description="Whether to extract entities at the video level. Mutually exclusive with enable_segment_level_entities - only one can be true.")
    enable_segment_level_entities: Optional[StrictBool] = Field(default=None, description="Whether to extract entities at the segment level. Mutually exclusive with enable_video_level_entities - only one can be true.")
    enable_transcript_mode: Optional[StrictBool] = Field(default=None, description="When enabled, extract entities from transcript only (similar to YouTube path). Useful for speech-heavy content.")
    ...
    __properties: ClassVar[List[str]] = ["segmentation_id", "segmentation_config", "url", "prompt", "schema", "enable_video_level_entities", "enable_segment_level_entities", "enable_transcript_mode", "thumbnails_config", "include_chapters", "include_shots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enable_video_level_entities": obj.get("enable_video_level_entities"),
            "enable_segment_level_entities": obj.get("enable_segment_level_entities"),
            "enable_transcript_mode": obj.get("enable_transcript_mode"),
