...
class SegmentsList(BaseModel):
    ...
    data: List[SegmentsListItem] = Field(description="Array of segmentation job objects (without segments array or total_segments)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [SegmentsListItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
