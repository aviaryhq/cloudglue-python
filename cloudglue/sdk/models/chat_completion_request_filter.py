...
class ChatCompletionRequestFilter(BaseModel):
    ...
    video_info: Optional[List[ChatCompletionRequestFilterVideoInfoInner]] = Field(default=None, description="Filter by video information. Use scope 'file' for source video properties or 'segment' for segment properties (e.g. segment duration).")
