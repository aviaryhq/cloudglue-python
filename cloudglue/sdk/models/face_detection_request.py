...
class FaceDetectionRequest(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="URL of the target video to analyze")
    ...
    __properties: ClassVar[List[str]] = ["url", "frame_extraction_id", "frame_extraction_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FaceDetectionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FaceDetectionRequest from a dict"""
        if obj is None:
            return None
