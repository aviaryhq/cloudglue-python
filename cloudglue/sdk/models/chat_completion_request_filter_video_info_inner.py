...
class ChatCompletionRequestFilterVideoInfoInner(BaseModel):
    ...
    scope: Optional[StrictStr] = Field(default=None, description="Scope of the filter. 'file' filters by source video properties, 'segment' filters by segment properties. Only duration_seconds is supported with segment scope.")
