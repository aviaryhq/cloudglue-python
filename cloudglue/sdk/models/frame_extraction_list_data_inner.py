...
class FrameExtractionListDataInner(BaseModel):
    """
    FrameExtractionListDataInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["frame_extraction_id", "status", "created_at", "file_id", "frame_extraction_config", "frame_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FrameExtractionListDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FrameExtractionListDataInner from a dict"""
        if obj is None:
            return None
