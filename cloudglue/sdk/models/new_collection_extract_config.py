...
class NewCollectionExtractConfig(BaseModel):
    ...
    enable_transcript_mode: Optional[StrictBool] = Field(default=False, description="When enabled, extract entities from transcript only. Useful for speech-heavy content.")
