...
class RichTranscript(BaseModel):
    ...
    segment_summary: Optional[List[TranscribeDataAllOfSegmentSummaryInner]] = Field(default=None, description="Array of summary information for each segment of the video. Only available when enable_summary is set to true in the transcribe configuration.")
    __properties: ClassVar[List[str]] = ["visual_scene_description", "scene_text", "speech", "audio_description", "collection_id", "file_id", "content", "title", "summary", "duration_seconds", "segment_summary"]
