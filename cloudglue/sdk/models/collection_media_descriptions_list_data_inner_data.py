...
class CollectionMediaDescriptionsListDataInnerData(BaseModel):
    """
    CollectionMediaDescriptionsListDataInnerData
    """ # noqa: E501
    ...
    segment_summary: Optional[List[TranscribeDataAllOfSegmentSummaryInner]] = Field(default=None, description="Array of summary information for each segment of the video")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionMediaDescriptionsListDataInnerData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionMediaDescriptionsListDataInnerData from a dict"""
        if obj is None:
            return None
