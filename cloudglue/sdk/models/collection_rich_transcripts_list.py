...
class CollectionRichTranscriptsList(BaseModel):
    """
    CollectionRichTranscriptsList
    """ # noqa: E501
    object: StrictStr = Field(description="Object type, always 'list'")
    data: List[CollectionRichTranscriptsListDataInner] = Field(description="Array of rich transcription data")
    total: StrictInt = Field(description="Total number of files with rich transcription data matching the query")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionRichTranscriptsList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionRichTranscriptsList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [CollectionRichTranscriptsListDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
