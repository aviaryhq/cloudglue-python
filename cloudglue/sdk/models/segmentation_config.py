...
class SegmentationConfig(BaseModel):
    """
    Configuration for video segmentation. **Choose a strategy and provide ONLY the corresponding config:**  • **uniform**: Provide `uniform_config`, do NOT provide `shot_detector_config` or `manual_config` • **shot-detector**: Provide `shot_detector_config`, do NOT provide `uniform_config` or `manual_config` • **manual**: Provide `manual_config`, do NOT provide `uniform_config` or `shot_detector_config`  Optionally specify `start_time_seconds` and `end_time_seconds` to limit segmentation to a portion of the video.
    """ # noqa: E501
