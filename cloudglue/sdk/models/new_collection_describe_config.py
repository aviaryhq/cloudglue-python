...
class NewCollectionDescribeConfig(BaseModel):
    """
    🎯 **Use ONLY when collection_type = 'media-descriptions'**  Configuration for comprehensive media description from videos. Optional - if not provided, default values will be used. This config will be ignored for other collection types.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["enable_summary", "enable_speech", "enable_scene_text", "enable_visual_scene_description", "enable_audio_description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewCollectionDescribeConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewCollectionDescribeConfig from a dict"""
        if obj is None:
            return None
