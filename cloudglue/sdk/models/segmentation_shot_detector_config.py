...
class SegmentationShotDetectorConfig(BaseModel):
    ...
    min_seconds: Optional[Union[Annotated[float, Field(le=600, strict=True, ge=1)], Annotated[int, Field(le=600, strict=True, ge=1)]]] = Field(default=None, description="The minimum length of a shot in seconds. Defaults to 1.")
    max_seconds: Optional[Union[Annotated[float, Field(le=600, strict=True, ge=1)], Annotated[int, Field(le=600, strict=True, ge=1)]]] = Field(default=None, description="The maximum length of a shot in seconds. Defaults to 300.")
    ...
    fill_gaps: Optional[StrictBool] = Field(default=None, description="When true, gaps between detected shots are filled: gaps greater than or equal to min_seconds become their own segments (split by max_seconds if needed), and shorter gaps are merged into the nearest adjacent segment. Defaults to true.")
