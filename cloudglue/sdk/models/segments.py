...
class Segments(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job_id", "file_id", "object", "status", "criteria", "created_at", "shot_config", "narrative_config", "total_segments", "total_shots", "segments", "shots"]
