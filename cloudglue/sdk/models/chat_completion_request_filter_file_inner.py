...
class ChatCompletionRequestFilterFileInner(BaseModel):
    """
    ChatCompletionRequestFilterFileInner
    """ # noqa: E501
    path: StrictStr = Field(description="JSON path on file object (e.g. 'uri', 'id', 'filename', 'created_at', 'bytes')")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatCompletionRequestFilterFileInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatCompletionRequestFilterFileInner from a dict"""
        if obj is None:
            return None
